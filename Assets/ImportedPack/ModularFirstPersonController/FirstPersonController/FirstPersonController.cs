...
// Custom Editor
    ...
    public override void OnInspectorGUI()
    {
        ...
        fpc.cameraRoot = (Transform)EditorGUILayout.ObjectField(new GUIContent("Camera Root", "Camera attached to the controller."), fpc.cameraRoot, typeof(Transform), true);
